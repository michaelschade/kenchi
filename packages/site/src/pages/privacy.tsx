...
// TODO: dedupe when app.kenchi.com/privacy (same content as of June 22)
export default function Privacy() {
  return (
    <BaseLayout data-columns="3,1">
      <Helmet>
        <title>Privacy Policy - Kenchi</title>
      </Helmet>
      <Copy>
        <header>
          <h1>Kenchi</h1>
        ...
        <p>
          <em>Last Updated: March 26, 2020</em>
        </p>
        <p>
